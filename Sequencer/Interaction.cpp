...
std::string Interaction::get_message() const { return this->message_; }

Participant Interaction::get_from() const { return this->from_participant_; }

Participant Interaction::get_to() const { return this->to_participant_; }

int Interaction::get_index() const { return this->index_; }

bool Interaction::is_reply() const { return this->is_reply_; }

bool Interaction::is_async() const { return this->is_async_; }
